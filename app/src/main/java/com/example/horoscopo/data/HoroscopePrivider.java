...
public class HoroscopePrivider {

        private val horoscopeList:List<Horoscope> = HoroscopePrivider(Horoscope("aries", R.string.horoscope_name_aries, R.string.horoscope_date_aries, R.drawable.aries_icon),
